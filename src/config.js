...
//  por este endereço.
//
//  Repare que o front (localhost:5173) e o back (backend-3-b-ten.vercel.app)
...
export const API_URL =
  import.meta.env.VITE_API_URL || "https://backend-3-b-ten.vercel.app";

// Chave usada para guardar o token no localStorage do navegador.
export const CHAVE_SESSAO = "sessao-3b-ten";
